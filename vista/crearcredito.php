  ...
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <div class="container text-center">
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">Nuevo credito</h1>
        <p >Ingresar el saldo de su credito deseado en JaveCoins (1 JaveCoin = $ 1000 COP).</p>
        </div>
      <form class="form" action="../controlador/crearcredito.php" method="post">
        <div class="row">
          <div class="col-6">
            ...
            <label for="inputPassword2" class="sr-only">Tasa de interes a pagar</label>
            <input type="number" name="interes" class="form-control"  placeholder="Interes" required>
            <label for="inputPassword2" class="sr-only">Fecha de pago del credito</label>
            <input type="date" name="fecha" class="form-control"  placeholder="Fecha pago" required>
          </div>
